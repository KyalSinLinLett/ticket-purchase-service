...
export const getEventTicketsValidator = [
  check('event_id').isUUID().withMessage('Must be a valid UUID'),
]
...
export const newEventValidator = [
  ...
  check('created_by').isUUID().withMessage('created_by must be a valid UUID'),
...
export const editEventDetailsValidator = [
  check('id').isUUID().withMessage('ID must be a valid UUID'),
